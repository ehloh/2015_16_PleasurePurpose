...
plcf= shiftdim(data(:, col.PLcf),1);  ppcf= shiftdim(data(:, col.PPcf),1); 

% Scores are scaled by conflict in that dimension 
pl1=pl1./plcf;  pl2=pl2./plcf;
pp1=pp1./ppcf; pp2=pp2./ppcf;

% Linear combination of attribute scores 
V(:,:,1) = repmat(pl1+pp1, nPP,1);
V(:,:,2) = repmat(pl2+pp2, nPP,1);
